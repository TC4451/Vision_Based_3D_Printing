""" Layer visualization by using the gcode file
...
def get_layer_coordinates(gcode_path, target_layer = 1, target_type = 2):
    ...
    # Code for generating the colored plot
    # fig = plt.figure()
    # plt.subplot(111)
    # plt.axis("equal")
...
# For layer-specific visualization
# import numpy as np
# import matplotlib.pyplot as plt

# gcode_noTri_path = 'printer_communication/gcode/SmallBellow_manualseam_only_Oct25.gcode'
# shape_list_X, shape_list_Y, z_val = get_layer_coordinates(gcode_noTri_path, 12)

# fig = plt.figure()
# for i in range(len(shape_list_Y)):
#     plt.plot(shape_list_X[i], shape_list_Y[i], 'red')
# plt.axis("equal")
# frame1 = plt.gca()
